...
%d day%s, %02d:%02d, There have been %ld questions asked, %ld topic additions, and %ld topic deletions. \
...
%d hour%s, %d min%s, There have been %ld questions asked, %ld topic additions, and %ld topic deletions. \
Process time: %1.4lf sec%s\n",a,b,c,d,e,f,g,h,i,j,k,l)
#define	L028(a,b,c,d,e,f,g,h,i,j,k,l) S("PRIVMSG %s :Running %s. I have %ld topics in my database, Uptime: \
%d min%s, %d sec%s, There have been %ld questions asked, %ld topic additions, and %ld topic deletions. \
Process time: %1.4lf sec%s\n",a,b,c,d,e,f,g,h,i,j,k,l)
