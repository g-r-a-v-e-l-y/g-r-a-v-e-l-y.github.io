...
if ($dropdown eq "startuser") {
	...
	if ($newnumber > $totals) {
	$arrayend = $totals;
	$are_we_done = "<p>$txt{'167'} [ <a href=\"$boardurl/$thisprogram\">$txt{'168'}</a> ]<br></p>";
	}
	else {
...
<table width=100%>
<tr>
	<td><p><IMG SRC="$imagesdir/open.gif" BORDER=0>&nbsp;&nbsp;<A href="$boardurl/YaBB.pl">$mbname</A><br><IMG SRC="$imagesdir/tline.gif" BORDER=0><IMG SRC="$imagesdir/open.gif" BORDER=0>&nbsp;&nbsp;$txt{'166'}</p></td>
</tr>
</table>

<table border=0 width=100% cellspacing=1 cellpadding=4 bgcolor="$color{'bordercolor'}">
<tr>
<td colspan=\"2\" bgcolor=\"$color{'titlebg'}\"><p>$txt{'173'}: $search - $totaldone $txt{'174'}</p></td>
</tr><tr>
<td colspan=\"2\" bgcolor=\"$color{'windowbg'}\"><p>$resulttext</p></td>
<tr>
EOT
		...
		print "<td bgcolor=\"$color{'windowbg2'}\" valign=top><p>$tempdate</p></td>";
		print "<td bgcolor=\"$color{'windowbg2'}\" valign=top><p>&nbsp;[ $tempcatboard] <a href=\"$boardurl/YaBB.pl?board=$temptitle&action=display&num=$tempmessage\" target=\"_blank\">$tempmessagetitle</a></p></td>";
		print "</tr><tr>";
		print "<td colspan=\"2\" bgcolor=\"$color{'windowbg'}\" valign=top><p>$txt{'197'}: <p>$tempposter</p><br>$tempsnippet...</p></td>";
		print "</tr><tr>";
		$counter2++;
		}

		print "<td colspan=\"2\" bgcolor=\"$color{'titlebg'}\"><p>$are_we_done</p></td>";
...
<table border=0 width=100% cellspacing=1 cellpadding=4 bgcolor="$color{'bordercolor'}">
<tr>
<td colspan=\"2\" bgcolor=\"$color{'titlebg'}\"><p>$txt{'177'}: $search - $totaldone $txt{'174'}</p></td>
</tr><tr>
<td colspan=\"2\" bgcolor=\"$color{'windowbg'}\"><p>$resulttext</p></td>
<tr>
EOT
...
<table border=0 width=100% cellspacing=1 cellpadding=4 bgcolor="$color{'bordercolor'}">
<tr>
<td colspan=\"2\" bgcolor=\"$color{'titlebg'}\"><p>$txt{'180'} $search - $totaldone $txt{'174'}</p></td>
</tr><tr>
<td colspan=\"2\" bgcolor=\"$color{'windowbg'}\"><p>$resulttext</p></td>
<tr>
EOT
