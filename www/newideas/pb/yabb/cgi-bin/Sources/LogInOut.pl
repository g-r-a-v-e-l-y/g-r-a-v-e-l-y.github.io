...
<tr>
	<td class="title1" bgcolor="$color{'titlebg'}"><p>$txt{'34'}</p></td>
</tr>
<tr>
...
<tr>
	<td align="right"><p>$txt{'36'}:</p></td>
	<td><p><input type=password name="passwrd" size=20></p></td>
</tr>
<tr>
	<td align="right"><p>$txt{'497'}:</p></td>
	<td><p><input type=text name="cookielength" size=4 maxlength="4" value="$Cookie_Length"></p></td>
</tr>
<tr>
	<td align="right"><p>$txt{'508'}:</p></td>
