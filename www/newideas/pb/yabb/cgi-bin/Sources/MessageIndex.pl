...
<tr>
	<td class="title1" bgcolor="$color{'titlebg'}" width=16><p>&nbsp;</p></td>
	<td class="title1" bgcolor="$color{'titlebg'}" width=16><p>&nbsp;</p></td>
	<td class="title1" bgcolor="$color{'titlebg'}"><p>$txt{'70'}</p></td>
	<td class="title1" bgcolor="$color{'titlebg'}"><p>$txt{'109'}</p></td>
	<td class="title1" bgcolor="$color{'titlebg'}" align=center><p>$txt{'110'}</p></td>
	<td class="title1" bgcolor="$color{'titlebg'}" align=center><p>$txt{'301'}</p></td>
	<td class="title1" bgcolor="$color{'titlebg'}" align=center><p>$txt{'111'}</p></td>
EOT
	...
	if( $musername ne 'Guest' ) {
     &LoadUser($musername);
     $mname = $userprofile{$musername}->[1] || $mname;
...
<tr>
	...
	<td class="form1" valign=middle bgcolor="$color{'windowbg'}"><p><a href="$cgi&action=display&num=$mnum">$msub</a> $new $pages</p></td>
	<td class="form2" valign=middle bgcolor="$color{'windowbg2'}"><p>$mname</p></td>
	<td class="form1" valign=middle align=center bgcolor="$color{'windowbg'}"><p>$mreplies</p></td>
	<td class="form1" valign=middle align=center bgcolor="$color{'windowbg'}"><p>$views</p></td>
	<td class="form2" valign=middle align=center bgcolor="$color{'windowbg2'}"><p>$mydate<br>by $lastpostername</p></td>
</tr>
EOT
		++$counter;
	}
...
EOT
    ...
    <BR><img src="$imagesdir/thread.gif"> $txt{'457'}</p></td>
