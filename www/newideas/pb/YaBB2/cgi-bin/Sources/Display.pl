...
<table border=0 width=100% cellspacing=1 cellpadding=3  bgcolor="$color{'bordercolor'}">
  <tr>
    <td class="title1" bgcolor="$color{'titlebg'}"><table border=0 cellspacing=0 cellpadding=0><tr><td><font class="text1" color="$color{'titletext'}"><img src="$imagesdir/$threadclass.gif"></td><td><font size=2 class="text1" color="$color{'titletext'}">&nbsp;$txt{'29'}</font></td></tr></table></td>
    <td class="title1" bgcolor="$color{'titlebg'}"><font class="text1" color="$color{'titletext'}">$txt{'118'}: $msubthread</font></td>
  </tr>
EOT
