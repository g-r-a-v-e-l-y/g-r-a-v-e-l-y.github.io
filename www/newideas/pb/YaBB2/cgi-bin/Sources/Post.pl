...
<tr>
	<td align="right"><font size=2>$txt{'131'}:</font></td>
...
<tr>
	<td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}">$yytitle</font></td>
</tr>
<tr>
...
<tr>
	...
	<td><font size=2><textarea name=message rows=12 cols=52 wrap=virtual>$form_message</textarea></td>
</tr>
$notification
<tr>
...
<table border=0 width="70%" cellspacing=1 bgcolor="$color{'bordercolor'}" align="center">
  <tr>
    <td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}">$csubject</font></td>
  </tr><tr>
    <td class="form1" bgcolor="$color{'windowbg'}"><font size=2>$message</font></td>
  </tr><tr>
...
sub doshowthread {
	...
	<tr><td class="title1" bgcolor="$color{'titlebg'}" colspan=2><font size=2 class="text1" color="$color{'titletext'}">
	$txt{'468'}
	</td></tr>~;
