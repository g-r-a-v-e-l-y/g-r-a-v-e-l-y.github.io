...
$boardurl = "http://65.8.36.37/YaBB/cgi-bin";	# URL of your board's folder (without trailing '/')
...
$facesurl = "http://65.8.36.37/YaBB/yabbimages/avatars";		# URL to your avatars folder
...
$color{'windowbg'}   = "\#606060";    # Background color for messages/forms
$color{'windowbg2'}  = "\#606060";    # Background color for messages/forms etc.
$color{'catbg'}      = "\#606060";    # Background color for category (at Board Index)
