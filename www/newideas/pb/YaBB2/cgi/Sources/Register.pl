...
<tr>
	<td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'97'}</b> $txt{'517'}</font></td>
</tr>
<tr>
	<td class="form1" bgcolor="$color{'windowbg'}"><font size=2><form action="$cgi\&action=register2" method="POST" name="creator">
<table border=0>
<tr>
	<td align="right"><font size=2>* <b>$txt{'98'}: </b></font></td>
...
<tr>
	<td colspan=2>
	<font size=2><b>$txt{'479'}:</b></font></td>
</tr>
<tr>
...
<tr>
	<td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'97'}</b></font></td>
</tr>
<tr>
