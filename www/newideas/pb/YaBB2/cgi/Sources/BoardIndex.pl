...
sub BoardIndex {
	...
	$thelatestmember = qq~$txt{'201'}: <a href="$scripturl?action=viewprofile&username=$latestmember"><b>$userprofile{$latestmember}->[1]</b></a>~;
	$totalm = 0;
	$totalt = 0;
...
<tr>
	<td valign=bottom><font size=2><IMG SRC="$imagesdir/open.gif" BORDER=0> <b>$mbname</b></font></td>
	<td align=right><font size=2>$txt{'19'}: $memcount<br>
...
<tr>
	...
	<td class="title1" bgcolor="$color{'titlebg'}"><font class="text1" color="$color{'titletext'}" size=2><b>$txt{'20'}</b></font></td>
	<td class="title1" bgcolor="$color{'titlebg'}" nowrap align=center><font class="text1" color="$color{'titletext'}" size=2><b>$txt{'330'}</b></font></td>
	<td class="title1" bgcolor="$color{'titlebg'}" nowrap align=center><font class="text1" color="$color{'titletext'}" size=2><b>$txt{'21'}</b></font></td>
	<td class="title1" bgcolor="$color{'titlebg'}" width="150" nowrap align=center><font class="text1" color="$color{'titletext'}" size=2><b>$txt{'22'}</b></font></td>
	<td class="title1" bgcolor="$color{'titlebg'}" nowrap><font class="text1" color="$color{'titletext'}" size=2><b>$txt{'12'}</b></font></td>
</tr>
EOT
	...
	foreach $curcat (@categories) {
		...
		print <<"EOT";
<tr>
	<td colspan=6 class="cat1" bgcolor="$color{'catbg'}"><font size=2><b>$catname{$curcat}</b></font></td>
</tr>
EOT
		foreach $curboard (@{$catboards{$curcat}}) {
			chomp $curboard;
...
<tr>
	...
	<td class="form2" bgcolor="$color{'windowbg2'}" valign=top><font size=2><b><a href="YaBB.pl?board=$curboard">$curboardname</a></b><br>
	$curboarddescr</font></td>
	<td class="form2" bgcolor="$color{'windowbg2'}" valign="middle" align=center><font size=2>$threadcount{$curboard}</font></td>
	<td class="form2" bgcolor="$color{'windowbg2'}" valign="middle" align=center><font size=2>$messagecount{$curboard}</font></td>
	<td class="form2" bgcolor="$color{'windowbg2'}" valign="middle" align=center><font size=1>$lastposttime{$curboard}<BR>by $lastposter</font></td>
	<td class="form2" bgcolor="$color{'windowbg2'}" valign="middle"><font size=2>$showmods</font></td>
</tr>
EOT
		}
	}
...
EOT
	if($Show_RecentBar == 1) {
		print <<"EOT";
<tr>
	<td class="title1" colspan=2 bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'214'}</b></font></td>
</tr>
<tr>
	<td class="form1" bgcolor="$color{'windowbg2'}" width=10 valign=middle align=center><img src="$imagesdir/xx.gif" border="0"></td>
	<td class="form1" bgcolor="$color{'windowbg2'}" valign=top><font size=2><b><A href="$scripturl?action=recent">$txt{'214'}</A></b></font><br>
	<font size=1>
EOT
...
EOT
	...
	if($Show_MemberBar == 1) {
		print <<"EOT";
<tr>
	<td class="title1" colspan=2 bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'331'}</b></font></td>
</tr>
<tr>
	<td class="form1" bgcolor="$color{'windowbg2'}" width=10 valign=middle align=center><img src="$imagesdir/online.gif" border="0"></td>
	<td class="form1" bgcolor="$color{'windowbg2'}" valign=top><font size=2><b><A href="YaBB.pl?action=mlall">$txt{'332'}</A></b></font><br><font size=1>$txt{'200'}</font></td>
</tr>
EOT
	}
	print <<"EOT";
<tr>
	<td class="title1" colspan=2 bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'158'}</b></font></td>
</tr>
<tr>
	<td class="form1" bgcolor="$color{'windowbg2'}" width=10 valign=middle align=center><img src="$imagesdir/online.gif" border="0"></td>
...
EOT
	...
	if( $username ne 'Guest' ) {
		print <<"EOT";
<tr>
	<td class="title1" colspan=2 bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'159'}</b></font></td>
</tr>
<tr>
	<td class="form1" bgcolor="$color{'windowbg2'}" width=10 valign=middle align=center><img src="$imagesdir/pmon.gif" border="0"></td>
	<td class="form1" bgcolor="$color{'windowbg'}" valign=top><font size=2><b><a href="$scripturl?board=&action=im">$txt{'153'}</a></b></font><br><font size=1>$txt{'152'} $messnum
EOT
		if($messnum == 1) {
		print $txt{'471'};
		} else {
...
EOT
	...
	if( $username eq 'Guest' ) {
		print <<"EOT";
<tr>
	<td class="title1" bgcolor="$color{'titlebg'}" colspan="2"><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'34'}</b></font>
