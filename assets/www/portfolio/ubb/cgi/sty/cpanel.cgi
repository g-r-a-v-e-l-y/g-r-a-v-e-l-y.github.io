...
print<<Threads;
<FONT SIZE="2" FACE="$FontFace" COLOR="#FF0000">Note: only administrators may update HTML threads. <P>
...
<TR>
<TD>
<FONT SIZE="2" FACE="$FontFace"><B>Your User Name</B></FONT>
</td>
<td><INPUT TYPE="TEXT" NAME="UserName" SIZE=25 MAXLENGTH=25>
</td>
<TR>
<td>
<B><FONT SIZE="2" FACE="$FontFace">Your Password</FONT></B>
</td>
<td>
...
<BR><BR><BR>
<FONT SIZE="1" FACE="$FontFace" COLOR="$TextColor">Powered by the <A HREF="http://www.ultimatebb.com">Ultimate Bulletin Board</A><BR>Copyright, Infopop Corporation, 1998 - 2000.
</FONT>
</CENTER>
</BODY>
</HTML>
...
<FONT face="$FontFace" size="2" COLOR="#800000"><B>Perl Info:</b></FONT><BR>
You are using <b>Perl Version $]</b>
<P>
<FONT face-"$FontFace" size="2" COLOR="#800000"><B>Your Environmental Variables:</b></FONT>
<BR>
<FONT SIZE="1" FACE="$FontFace" COLOR="#008080">Note: "DOCUMENT_ROOT" shows your absolute path to your root web directory.  "SCRIPT_FILENAME" shows you absolute path of your CGI directory.  If your SCRIPT_FILENAME shows "/www/whatever/whatever/cgi-bin/cpanel.cgi", your Absolute Path variable for your CGI directory would be "/www/whatever/whatever/cgi-bin".</FONT><P>
TOP
for $key (keys(%ENV)) {
...
<BLOCKQUOTE>
<FONT SIZE="2" face="$FontFace"><B>Identify Yourself Below (case sensitive)</B></FONT><BR>
<TABLE BORDER=0>
<tr bgcolor="#DEDFDF"><td><FONT SIZE="2" FACE="$FontFace"><B>Your User Name</B></FONT></td>
<td><INPUT TYPE="TEXT" NAME="UserName" SIZE=25 MAXLENGTH=25>
</td>
</tr>
<tr bgcolor="$AltColumnColor2">
<td>
<FONT SIZE="2" FACE="$FontFace"><B>Your Password</B></FONT></td>
<td><INPUT TYPE="PASSWORD" NAME="Password" SIZE=15 MAXLENGTH=15></td>
</tr>
</table>
<P>
<FONT SIZE="2" face="$FontFace"><B>Conduct Member Search:</B></FONT>
<TABLE BORDER=1>
<TR bgcolor="#CCCC99">
<TD WIDTH=200 VALIGN=TOP><FONT SIZE="2" FACE="$FontFace"><B>User Name</B></FONT></td>
<td><INPUT TYPE="TEXT" NAME="NN" VALUE="" SIZE=25 MAXLENGTH=25></td></tr>
<TR bgcolor="#CCCC99">
<TD WIDTH=200 VALIGN=TOP><FONT SIZE="2" FACE="$FontFace"><B>Email Address</B></FONT></td>
<td><INPUT TYPE="TEXT" NAME="Email" VALUE="" SIZE=30 MAXLENGTH=70></td></tr>
<TR bgcolor="#CCCC99">
<TD WIDTH=200 VALIGN=TOP><FONT SIZE="2" FACE="$FontFace"><B>Number of Posts</B></FONT></td>
<td><SELECT NAME="Math">
	<OPTION VALUE="GT"> \>=
	<OPTION VALUE="LT"> \<=
	<OPTION VALUE="EQ"> ==
...
<FONT SIZE="2" face="$FontFace"><B>If you want to view the entire list of users rather than conduct a search, check this box (not recommended for large membership sites since it could take a long time to process).</B></FONT></td></tr></table>
</BLOCKQUOTE>
<br><br>
...
<BR><BR><BR>
<FONT SIZE="1" FACE="$FontFace" COLOR="$TextColor">Copyright, Infopop Corporation, 1998 - 2000.
</FONT>
</CENTER>
</BODY>
</HTML>
...
<p>&nbsp;</p>
<p align=center><FONT SIZE="2" FACE="$FontFace"><b>Your absolute paths need to be configured before you use the bulletin board.</b></FONT>
<P>

<p align=center><FONT SIZE="2" FACE="$FontFace"><B>Please <A HREF="cpanel2.cgi?action=DoGenVars">click here now.</a></b>
</p>
<BR><BR><BR>
<center><FONT SIZE="1" FACE="$FontFace" COLOR="$TextColor">Ultimate Bulletin Board $Version<br>Powered by Infopop &copy; 2000.
...
<FONT SIZE="2" FACE="$FontFace" COLOR="#FF0000">Note: only administrators may set moderators.  Identify yourself below.</FONT>
<FORM ACTION="cpanel2.cgi" METHOD="POST" NAME="THEFORM">
...
<TR bgcolor="#EFF5F3">
<TD>
<FONT SIZE="2" FACE="$FontFace" COLOR="$LinkColor"><B>Forum Name</B></FONT>
</td>
<td>
<FONT SIZE="2" FACE="$FontFace" COLOR="$LinkColor"><B>Current Moderator</B></FONT>
</td>
<td>
<FONT SIZE="2" FACE="$FontFace" COLOR="$LinkColor"><B>Change to:</B></FONT>
</td>
ModTOP
...
<TR bgcolor="#F7F7F7">
<TD>
<FONT SIZE="2" FACE="$FontFace"><B>$ForumName</B></FONT>
</td>
<td>
<FONT SIZE="2" FACE="$FontFace">$Moderator</FONT>
</td>
<td>
