...
<TR bgcolor="$TextColor"><TD COLSPAN=2 align=center><B><FONT SIZE="2" FACE="$FontFace" color="#FFFF00">absolute paths</FONT></B>
</TD></TR>
<TR bgcolor="#FCF0C0">
<TD colspan=2><FONT SIZE="1" FACE="$FontFace">
...
<p>
For UNIX servers:  &nbsp;&nbsp;&nbsp;&nbsp;<FONT SIZE="1" FACE="$FontFace" COLOR="#FF0000">/usr/home/yourdomain/www/cgi-bin</font>
<BR>
For Win32/NT servers:&nbsp;&nbsp;&nbsp;&nbsp; <FONT SIZE="1" FACE="$FontFace" COLOR="#FF0000">C:/home/yourdomain/cgi-bin</FONT>
<P>
...
<td width=50%>
<FONT SIZE="2" FACE="$FontFace"><B>Absolute Path for your UBB CGI DIRECTORY</B><br></FONT>
</td>
...
<td width=50%>
<FONT SIZE="2" FACE="$FontFace"><B>Absolute Path of your UBB NON CGI Directory</B><br></FONT>
</td>
<td width=50% valign=top>
...
<tr bgcolor="$AltColumnColor2">
<td width=50%>
<FONT SIZE="2" FACE="$FontFace"><B>Absolute Path to Members Directory</B><br></FONT>
<FONT SIZE="1" FACE="$FontFace">This path should end in /Members (as in "/usr/home/yourdomain/www/cgi-bin/Members")</FONT>
</td>
<td width=50% valign=top>
...
<tr bgcolor="$AltColumnColor1">
<td width=50%>
<FONT SIZE="2" FACE="$FontFace"><B>Absolute Path to Directory Where Your Custom Variable Files  Reside</B><br></FONT>
<FONT SIZE="1" FACE="$FontFace"><B>You should use the same absolute path that you used for your CGI directory above</B>.  If for some reason you cannot write to files in your CGI directory, however, you should place these files (UltBB.setup, forums.cgi, mods.file, Styles.file) in a directory below the web root so that they cannot be accessed by anyone from the browser. </FONT>
</td>
<td width=50% valign=top>
...
<P>
<table border=0 width=100%>
<TR bgcolor="$TextColor"><TD COLSPAN=2 align=center><p><B><FONT SIZE="2" FACE="$FontFace" color="#FFFF00">URLs</FONT></B>
</p></TD></TR>

<TR bgcolor="#FCF0C0">
<TD colspan=2><FONT SIZE="1" FACE="$FontFace"><p>
...
<tr bgcolor="$AltColumnColor2">
<td width=50%>
<FONT SIZE="2" FACE="$FontFace"><B>URL for your UBB CGI Directory</B><br></FONT>
</td>
<td width=50% valign=top>
...
<tr bgcolor="$AltColumnColor1">
<td width=50%>
<FONT SIZE="2" FACE="$FontFace"><B>URL for your UBB Non-CGI Directory</B><br></FONT>
</td>
<td width=50% valign=top>
...
<TR bgcolor="$AltColumnColor2">
<td width=50%>
<FONT SIZE="2" FACE="$FontFace"><p><B>Your Home Page URL</B><br></FONT>
<FONT SIZE="1" FACE="$FontFace">The complete URL for your home page (not the bulletin board).  This will be used for links back to your homepage.</FONT></p>
</td>
<td width=50% valign=top>
...
&InputTextRow("$AltColumnColor1", "<p>Your Privacy Statement", "</b>The complete URL for your web site's privacy statement.  This will be used to describe your policies concerning user information.</p>", "PrivacyURL", "40", "250");


&InputRadioRow("$AltColumnColor2", "<p>Display Privacy Statement Link ?", "</b>You can display the link to your Privacy Statement on every UBB page.  Check yes to include it. Note: if you check no, your Privacy URL will still appear in any Children's Online Protection routines.</p>", "<INPUT TYPE=\"RADIO\" NAME=\"ShowPrivacyLink\" VALUE=\"ON\" $ShowPrivacyLinkON> Yes<br>
...
<table border=0 width=100%>
<TR bgcolor="$TextColor"><TD COLSPAN=2 align=center><B><FONT SIZE="2" FACE="$FontFace" color="#FFFF00">Display Options</FONT></B>
</TD></TR>
...
<TR bgcolor="$AltColumnColor2">
<td width=50%><p>
<FONT SIZE="2" FACE="$FontFace"><B>Your Email Address</B></FONT><br>
<FONT SIZE="1" FACE="$FontFace">This is email address that will be shown so that users can contact you</FONT></p>
</td>
<td width=50% valign=top>
...
<TR bgcolor="$AltColumnColor1">
<td width=50%>
<FONT SIZE="2" FACE="$FontFace"><B>Name of Your Bulletin Board</B><br></FONT>
</td>
<td width=50% valign=top>
...
<TR bgcolor="$AltColumnColor2">
<td width=50%>
<FONT SIZE="2" FACE="$FontFace"><p><B>Name of Your Home Page</B><br></FONT>
<FONT SIZE="1" FACE="$FontFace" >The name of your homepage, which will listed for links back to your homepage.</FONT></p>
</td>
<td width=50% valign=top>
...
<tr bgcolor="$AltColumnColor1">
<td width=50%>
<FONT SIZE="2" FACE="$FontFace"><B>Display Forum Descriptions?</B><br></FONT>
<FONT SIZE="1" FACE="$FontFace">If you have many forums, you may not want to display your forum descriptions.  If not, check no.</FONT></td>
<td width=50% valign=top>
<FONT SIZE="2" FACE="$FontFace"><INPUT TYPE="RADIO" NAME="ForumDescriptions" VALUE="yes" $ForumDescriptionsOn> yes<br>
...
<FONT SIZE="2" FACE="$FontFace"><B>Bulletin Board Rules</B><BR></FONT>
<FONT SIZE="1" FACE="$FontFace">You can customize the exact wording for your bulletin board's rules.  Just edit the wording in the box to the right.</FONT></p>
</td>
<td width=50% valign=top>
<FONT SIZE="2" FACE="$FontFace"><B>$BBName Rule Wording:</B><br></FONT>
<TEXTAREA NAME="BBRules" ROWS=8 COLS=35 wrap="virtual">$BBRules
</TEXTAREA>
</td></tr>
); #end qq

&InputRadioRow("$AltColumnColor1", "Children's Online Privacy Protection [COPPA]", "This option must be used by all sites which expect to register users under the age of 13. Though this is an American law, it may affect non-US sites too.  Consult competent legal advice. Activating this option will ask the user's age and send him/her to a special registration page.", "<INPUT TYPE=\"RADIO\" NAME=\"COPPACheck\" VALUE=\"ON\" $COPPACheckON>  Age Check Required<br><INPUT TYPE=\"RADIO\" NAME=\"COPPACheck\" VALUE=\"OFF\" $COPPACheckOFF> Age Check Not Required");

print qq(
<tr bgcolor="$AltColumnColor2">
<td width=50% valign=top>
<FONT SIZE="2" FACE="$FontFace"><p><B>COPPA Instructions</B><BR></FONT>
<FONT SIZE="1" FACE="$FontFace">Provide detailed instructions for how a user under 13 can mail or FAX you a parental permission form.</FONT></p>
</td>
<td width=50% valign=top>
<FONT SIZE="2" FACE="$FontFace"><B>Instructions:</B><br></FONT>
...
<TR bgcolor="$AltColumnColor1">
<td width=50% valign=top><p>
<FONT SIZE="2" FACE="$FontFace"><B>Block Public Display of User Email Addresses?</B><BR></FONT>
<FONT SIZE="1" FACE="$FontFace">The default option is to have registered user's email addresses viewable on the pages for which the user has posted a note.  You may prevent all user email addresses from being displayed by selecting "Block Email Address Display" in the field to the right.  These addresses will still be available to you if you check the user's info in the "User Info/Permissions" area of the Control Panel.</FONT></p>
</td><td width=50% valign=top>
<FONT SIZE="2" FACE="$FontFace"><INPUT TYPE="RADIO" NAME="EmailBlock" VALUE="ON" $EmailBlockOn> Block Public Display of User Email Addresses<BR>
...
<P>
<table border=0 width=100%>
<TR bgcolor="$TextColor"><TD COLSPAN=2 align=center><B><FONT SIZE="2" FACE="$FontFace" color="#FFFF00">Date/Time Display Options</FONT></B>
</TD></TR>
...
<TR bgcolor="$AltColumnColor1">
<td width=50%><p>
<FONT SIZE="2" FACE="$FontFace"><B>Time Zone</B><br></FONT>
<FONT SIZE="1" FACE="$FontFace">The time of each posting is based on the time zone where your server is located.  If you want your users to know the time zone, provide it here (e.g., ET, CT, PT, etc.).  You may also leave this blank if you would prefer not to show a time zone.  You may type a different time zone than your server uses, but if you do so be sure to provide a time zone offset in the next field.</FONT>
</p></td>
<td width=50% valign=top>
...
<TR bgcolor="$AltColumnColor2">
<td width=50%><p>
<FONT SIZE="2" FACE="$FontFace"><B>Server Time Zone Offset</B></FONT><br>
<FONT SIZE="1" FACE="$FontFace">You can offset the time drawn from your web server.  For instance, if your server time is EST (US), but you want all time to reflect Pacific Time (US), you would have to offset your server time by placing the time zone difference in this field (for this example, that would be -3.  You would place -3 in this field).  The default is for there to be no server time zone offset (0).</FONT></p>
</td>
<td width=50% valign=top>
...
<TR bgcolor="$AltColumnColor1">
<td width=50% valign=top>
<FONT SIZE="2" FACE="$FontFace"><B>Date Format</B></FONT><BR>
<FONT SIZE="1" FACE="$FontFace">European Format is DD-MM-YR, while US format is MM-DD-YR.</FONT>
</td>
<td width=50%>
...
<TR bgcolor="$AltColumnColor2">
<td width=50% valign=top><p>
<FONT SIZE="2" FACE="$FontFace"><B>Time Format</B></FONT><BR>
<FONT SIZE="1" FACE="$FontFace">You can have time displayed in AM/PM format, or in 24-hour format.</FONT>
</p>
</td>
<td width=50%>
<FONT SIZE="2" FACE="$FontFace">
...
<table border=0 width=100%>
<TR bgcolor="$TextColor"><TD COLSPAN=2 align=center><B><FONT SIZE="2" FACE="$FontFace" color="#FFFF00">Miscellaneous Options</FONT></B>
</TD></TR>
...
<TR bgcolor="$AltColumnColor2">
<td width=50%><p>
<FONT SIZE="2" FACE="$FontFace"><B>Email Duplicate Check</B><br></FONT>
<FONT SIZE="1" FACE="$FontFace">The default option is to require unique email addresses for each registered user.  This means that no two users can have the same email address. You can disable this requirement by checking the "Unique Email Not Required" box.</FONT></p>
</td>
<td width=50% valign=top>
<FONT SIZE="2" FACE="$FontFace"><INPUT TYPE="RADIO" NAME="EmailCheck" VALUE="true" $EmailTrue> Unique Email Required<br>
...
<P>
<br>
<CENTER><FONT Size="2" FACE="$FontFace"><B>Enter your UserName & Password:</font>
<P>
...
<td valign=bottom width=140><FONT SIZE="1" FACE="$FontFace"><B>User Name<BR>Date Registered</B></FONT></td>
...
<td valign=bottom><FONT SIZE="1" FACE="$FontFace"><B>Total Posts</B></FONT></td>
</tr>
HTML_TOP
...
<td><FONT SIZE="1" FACE="$FontFace"><A HREF="cpanel.cgi?action=getbio4admin&UserName=$UNCoded">$searchrow[0]</A><BR>$DateReg</font></td>
...
<td><FONT SIZE="1" FACE="$FontFace">$searchrow[8]</FONT></td>
<td><FONT SIZE="1" FACE="$FontFace">$searchrow[7]</FONT></td>
</tr>
GUTS
...
<br>
<CENTER><FONT Size="2" FACE="$FontFace" COLOR="#800000"><B>For security reasons, re-enter your UserName & Password: <BR>
UserName: <INPUT TYPE="TEXT" NAME="UserNameCheck" SIZE=25 MAXLENGTH=25>&nbsp;&nbsp;&nbsp;&nbsp; Password <INPUT TYPE="PASSWORD" NAME="PasswordCheck" SIZE=13 MAXLENGTH=13></FONT></B></CENTER>
<p>
...
<p>
Total Registered Users: <FONT SIZE="2" FACE="$FontFace" COLOR="#800000"><b>$TotalMembers</B></FONT><BR>
Search Matches: <FONT SIZE="2" FACE="$FontFace" COLOR="#800000"><b>$Search</B></FONT>
<P>
Make any changes necessary and then click on "Submit" to modify any/all user records.  Check the delete box on the left for all registrations you want deleted.<br><br>
...
<td valign=bottom><FONT SIZE="1" FACE="$FontFace"><B>User Name<BR>Date Registered</B></FONT></td>
<td valign=bottom ><FONT SIZE="1" FACE="$FontFace" COLOR="#FF0000"><B>Able to post notes?</B></FONT></td>
<td valign=bottom><FONT SIZE="1" FACE="$FontFace" COLOR="#FF0000"><B>Authorized Administrator?</B></FONT></td>
<td valign=bottom><FONT SIZE="1" FACE="$FontFace"><B>Status</B></FONT></td>
<td valign=bottom><FONT SIZE="1" FACE="$FontFace"><B>Total Posts</B></FONT></td>
...
<td><FONT SIZE="1" FACE="$FontFace">$searchrow[4]</FONT></td></tr>
GUTS
...
<br>
<FONT Size="2" FACE="$FontFace" COLOR="#800000"><B>For security reasons, re-enter your UserName & Password: <BR>
...
print<<Error;
<HTML><BODY BGCOLOR="$BGColor" link="$LinkColor" vlink="#808000">
...
<tr bgcolor="$RowColor">
<td width=50%>
<FONT SIZE="2" FACE="$FontFace"><B>$FieldName</B></FONT>
<FONT SIZE="1" FACE="$FontFace"><B>$Notes</B></FONT>
</td>
<td width=50% valign=top>
...
<td width=50%>
<FONT SIZE="2" FACE="$FontFace"><B>$FieldName</B></FONT>
<FONT SIZE="1" FACE="$FontFace">$Notes</FONT></td>
<td width=50% valign=top>
<FONT SIZE="2" FACE="$FontFace">
$RadioStuff
</FONT>
