...
print<<BOTTOM;
<B><FONT SIZE="2" FACE="$FontFace">
<A HREF="mailto:$BBEmail">Email Grant</A> | <A HREF="$HomePageURL">$MyHomePage</A> $PrivacyLink
</B></FONT>
<p><FONT SIZE="2" FACE="$FontFace" color="$TextColor">

<P></font>
<FONT COLOR="$TextColor" size="1" FACE="$FontFace">
<P>
Powered by Infopop: 
...
$ThePost =~ s/(\[QUOTE\])(.+?)(\[\/QUOTE\])/ <BLOCKQUOTE><font size="1" face="$FontFace">quote:<\/font><HR>$2<HR><\/BLOCKQUOTE>/isg;
...
<P><BR><blockquote>
<B><FONT FACE="$FontFace" size=2>$TextToPrint
</FONT></B></blockquote>
</BODY></HTML>
TheHTML
}
