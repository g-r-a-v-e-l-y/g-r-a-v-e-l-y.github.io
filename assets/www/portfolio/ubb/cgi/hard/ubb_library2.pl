...
<td valign=top align=left><A HREF="$CGIURL/Ultimate.cgi?action=intro"><IMG SRC="$NonCGIURL/bbtitle5.jpg" BORDER=0></A>
...
<A HREF="$CGIURL/postings.cgi?action=newtopic&number=$number&forum=$ForumCoded"><IMG SRC="$NonCGIURL/topic5.jpg"  BORDER=0 ALT="Post New Topic"></A>&nbsp;&nbsp;<A HREF="$CGIURL/postings.cgi?action=reply&forum=$ForumCoded&number=$number&topic=$ThreadFile&TopicSubject=$SubjectCoded"><IMG SRC="$NonCGIURL/reply5.jpg" border=0></A></FONT>
<BR>
...
$EmailString = qq(&nbsp;&nbsp;<A HREF="$CGIURL/Ultimate.cgi?action=email&ToWhom=$UNCoded" target=_new><IMG SRC="$NonCGIURL/email.gif" BORDER=0 WIDTH=24 HEIGHT=11 ALT="Click Here to Email $statarray[3]"></A>&nbsp;&nbsp;);
} 	
...
<TD valign=middle>
<FONT SIZE="1" face="Verdana, Arial" color="$000080"><B>Topic:&nbsp;&nbsp; $TopicSubject</B></FONT>
</TD>
</TR>
<tr bgcolor="#F7F7F7">
...
<FONT SIZE="2" FACE="Verdana, Arial">
<FONT SIZE="1" color="#000080" face="Verdana, Arial">posted $ThisDate $FormatTime $TimeZone&nbsp;&nbsp;&nbsp;<A HREF="$CGIURL/ubbmisc.cgi?action=getbio&UserName=$UNCoded" target=_new><IMG SRC="$NonCGIURL/profile.gif" WIDTH=22 HEIGHT=11 BORDER=0 ALT="Click Here to See the Profile for $statarray[3]"></A> $EmailString 
...
$EmailString = qq(&nbsp;&nbsp;<A HREF="$CGIURL/Ultimate.cgi?action=email&ToWhom=$UserNameCoded" target=_new><IMG SRC="$NonCGIURL/email.gif" BORDER=0 WIDTH=24 HEIGHT=11 ALT="Click Here to Email $thisline[2]"></A>&nbsp;&nbsp;);
} 	
...
<IMG SRC="$NonCGIURL/posticon.gif" BORDER=0>
<FONT SIZE="2" FACE="Verdana, Arial">
<FONT SIZE="1" color="$000080" face="Verdana, Arial">posted $ThisDate $FormatTime $TimeZone &nbsp;&nbsp;&nbsp;
<A HREF="$CGIURL/ubbmisc.cgi?action=getbio&UserName=$UserNameCoded" target=_new><IMG SRC="$NonCGIURL/profile.gif" WIDTH=22 HEIGHT=11 BORDER=0 ALT="Click Here to See the Profile for $thisline[2]"></A>$EmailString &nbsp;&nbsp;
...
$ThisThread .= qq(</table></center><p><table border=0 width=95%><tr><td><CENTER><A HREF="$CGIURL/postings.cgi?action=newtopic&number=$number&forum=$ForumCoded"><IMG SRC="$NonCGIURL/topic5.jpg" WIDTH=91 HEIGHT=21 BORDER=0 ALT="Post New Topic"></A>&nbsp;&nbsp;<A HREF="$CGIURL/postings.cgi?action=reply&forum=$ForumCoded&number=$number&topic=$ThreadFile&TopicSubject=$SubjectCoded"><IMG SRC="$NonCGIURL/reply5.jpg" WIDTH=91 HEIGHT=21 BORDER=0 ALT="Post Reply"></A></CENTER></TD>
