...
$mbname = "internal energy board";					# The name of your YaBB forum
$boardurl = "http://65.8.36.37/newideas/pb/yabb/cgi-bin";				# URL of your board's folder (without trailing '/')
...
$facesurl = "http://65.8.36.37/newideas/pb/yabbimages/avatars";				# URL to your avatars folder
$facesdir = "C:webinetpubwwwrootewideaspbyabbimagesvatars";				# Absolute Path to your avatars folder
$imagesdir = "http://65.8.36.37/newideas/pb/YaBBImages";				# URL to your images directory
$helpfile = "http://65.8.36.37/newideas/pb/yabbHelp/index.html";				# Location of your help file
...
$color{'windowbg'} = "#eeeeee";			# Background color for messages/forms etc.
...
$color{'bordercolor'} = "#ffffff";		# Table Border color for some tables
...
$maxdisplay = 10;				# Maximum of topics to display
...
$faderpath = "http://65.8.36.37/newideas/pb/yabb/fader.js";				# Web path to your 'fader.js'


########## UBBC JS Path ##########

$ubbcjspath = "http://65.8.36.37/newideas/pb/yabb/ubbc.js";	# Web path to your 'ubbc.js' REQUIRED for post/modify to work properly!
