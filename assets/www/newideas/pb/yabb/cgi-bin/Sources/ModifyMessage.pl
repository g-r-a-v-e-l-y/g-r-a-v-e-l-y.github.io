...
<tr>
	<td class="title1" bgcolor="$color{'titlebg'}"><p>$txt{'66'}</p></td>
</tr>
<tr>
...
<tr>
	...
	<td><p><input type=text name="subject" value="$msubject" size="40" maxlength="50"></p></td>
</tr>
<tr>
...
<tr>
	...
	<td><p><textarea name=message rows=12 cols=52 wrap=virtual>$mmessage</textarea></td>
</tr>
<tr>
	<td valign=top align="right"><p>$txt{'211'}:</p></td>
	<td><p>$lastmodification</td>
</tr>
<tr>
      <td align="right"><p>$txt{'276'}:</p><BR><BR></td>
      <td><p><input type=checkbox name="ns" value="NS"$nosmiley></p>
      <p>$txt{'277'}</p><BR><BR></td>
</tr>
<tr>
