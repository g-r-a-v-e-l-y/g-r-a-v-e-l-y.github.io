...
<tr>
	...
	<td class="title1" bgcolor="$color{'titlebg'}" nowrap><p>$txt{'42'}</p></td>
</tr>
EOT
	foreach $curcat (@categories) {
		...
		print <<"EOT";
<tr>
	<td colspan=4 bgcolor="#c0c0c0"><p><a href="$cgi&action=reorderboards&cat=$curcat">$curcatname</a></p></td>
</tr>
EOT
...
<tr>
	...
	<td bgcolor="#e0e0e0" width=* valign=top><p>
	...
	<textarea name=descr cols=50 rows=3>$descr</textarea></p></td>
...
<tr>
	...
	<textarea name=descr cols=50 rows=3></textarea></p></td>
...
<table border=0 width=100% cellspacing=1 bgcolor="$color{'bordercolor'}">
<tr>
	<td class="title1" bgcolor="$color{'titlebg'}"><p>$txt{'46'}</p></td>
</tr>
<tr>
