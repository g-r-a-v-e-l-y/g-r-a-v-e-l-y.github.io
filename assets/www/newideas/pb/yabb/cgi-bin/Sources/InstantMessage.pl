...
<tr>
 <td class="title1" bgcolor="$color{'titlebg'}" width="300"><p>&nbsp;$txt{'317'}</p></td>
 <td class="title1" bgcolor="$color{'titlebg'}"><p>$txt{'318'}</p></td>
 <td class="title1" bgcolor="$color{'titlebg'}"><p>$txt{'319'}</p></td>
 <td class="title1" bgcolor="$color{'titlebg'}"><p>&nbsp;</p></td>
</tr>
EOT
	...
	if(@messages==0) {
		print <<"EOT";
<tr>
	<td class="form1" colspan=4 bgcolor="$color{'windowbg'}"><p>$txt{'151'}</p></td>
</tr>
EOT
	}
	...
	for ($a = 0; $a < @messages; $a++) {
		...
		print "<tr>";
	        print "<td class=\"form2\" bgcolor=\"$second\" width=300><p>$mydate</p></td>";
	        print "<td class=\"form2\" bgcolor=\"$second\"><p>$musername[$a]</p></td>";
	        print "<td class=\"form2\" bgcolor=\"$second\"><p><a href=\"#$messageid[$a]\">$subject</a></p></td>";
		print "<td class=\"form2\" bgcolor=\"$second\"><p><a href=\"$cgi&action=imremove&caller=1&id=$messageid[$a]\">$txt{'31'}</a></p></td>";
		print "</tr>";
...
<table border=0 width=100% cellspacing=1 bgcolor="$color{'bordercolor'}">
<tr>
 <td class="title1" bgcolor="$color{'titlebg'}"><p>&nbsp;$txt{'29'}</p></td>
 <td class="title1" bgcolor="$color{'titlebg'}"><p>$txt{'118'}</p></td>
</tr>
EOT
	...
	if(@messages==0) {
		print <<"EOT";
<tr>
	<td class="form1" colspan=2 bgcolor="$color{'windowbg'}"><p>$txt{'151'}</p></td>
</tr>
EOT
	}
...
<tr>
	...
	<p><a href=\"$cgi\&action=viewprofile\&username=$musername[$a]\">$memset[1]</a></p><br>
	<p>$memberinfo<br>
	$star<br><br>
	$postinfo<br>
	$icq &nbsp; $yim &nbsp; $aim
...
<tr>
	<td width=100%><a name="$messageid[$a]"><p>&nbsp;$subject</p></td>
	<td align=right nowrap><p>$txt{'30'}: $mydate</p></td>
</tr>
</table>
	<hr></p>
<p>
...
<tr>
	<td class=\"form2\" bgcolor="$second"><table border=0 cellspacing=0 cellpadding=0 width=100%><tr><td><p>
$url<a href="mailto:$memset[2]">E-Mail</a>$viewd
</p></td><td align=right>
<p><a href="$cgi&action=imsend&caller=1&num=$a&quote=1&to=$musername[$a]">$txt{'145'}</a> | <a href="$cgi&action=imsend&caller=1&num=$a&reply=1&to=$musername[$a]">$txt{'146'}</a> | <a href="$cgi&action=imremove&caller=1&caller=1&id=$messageid[$a]">$txt{'154'}</a></p></td></tr></table></td>
</tr>
EOT
;
	}
...
<p><a href="$cgi&action=imsend">$txt{'148'}</a></p>
EOT
}
	&footer;
	exit;
...
<tr>
 <td class="title1" bgcolor="$color{'titlebg'}" width="300"><p>&nbsp;$txt{'317'}</p></td>
 <td class="title1" bgcolor="$color{'titlebg'}"><p>$txt{'324'}</p></td>
 <td class="title1" bgcolor="$color{'titlebg'}"><p>$txt{'319'}</p></td>
 <td class="title1" bgcolor="$color{'titlebg'}"><p>&nbsp;</p></td>
</tr>
EOT
...
EOT
	...
	for ($a = 0; $a < @messages; $a++) {
		...
		print "<tr>";
	        ...
	        print "<td class=\"form2\" bgcolor=\"$second\"><p>$musername[$a]</p></td>";
	        print "<td class=\"form2\" bgcolor=\"$second\"><p><a href=\"#$messageid[$a]\">$subject</a></p></td>";
		print "<td class=\"form2\" bgcolor=\"$second\"><p><a href=\"$cgi&action=imremove&caller=2&id=$messageid[$a]\">delete</a></p></td>";
		print "</tr>";
...
<tr>
	...
	<table border=0 cellspacing=0 cellpadding=0 width=100%>
<tr>
	<td width=100%><p><a name="$messageid[$a]">&nbsp;$subject</p></td>
	<td align=right nowrap><p>$txt{'30'}: $mydate</p></td>
</tr>
</table>
	<hr></p>
...
<p><a href="$cgi&action=imsend&caller=2&num=$a&quote=1&to=$musername[$a]">$txt{'145'}</a> | <a href="$cgi&action=imsend&caller=2&num=$a&reply=1&to=$musername[$a]">$txt{'146'}</a> | <a href="$cgi&action=imremove&caller=2&id=$messageid[$a]">$txt{'154'}</a></p></td></tr></table></td>
</tr>
EOT
;
	}
...
<table border=0 width=100% cellspacing=1 bgcolor="$color{'bordercolor'}">
 <tr>
  <td class="title1" bgcolor="$color{'titlebg'}"><p>$txt{'148'}</p></td>
 </tr>
 <tr>
   ...
   <form action="$cgi&action=imsend2" method=post>
    <table border=0>
     <tr>
      ...
      <td>
       <p><input type=text name="to" value="$INFO{'to'}" size="20" maxlength="50"></p>
      </td>
     </tr>
     <tr>
      <td>
      ...
      <td>
       <p><input type=text name="subject" value="$form_subject" size="40" maxlength="50"></p>
      </td>
     </tr>
     <tr>
      <td valign=top>
      ...
      <td>
       <p><textarea name=message rows=10 cols=50 wrap=physical>$form_message</textarea>
      </td>
     </tr>
     <tr>
...
<table border=0 width=100% cellspacing=1 bgcolor="$color{'bordercolor'}">
 <tr>
  <td class="title1" bgcolor="$color{'titlebg'}"><p>$txt{'323'}</p></td>
 </tr>
 <tr>
  <td class="form1" bgcolor="$color{'windowbg'}">
   <form action="$cgi&action=imprefs2" method=post>
    <table border=0>
     <tr>
      <td valign=top>
       <p>$txt{'325'}:</p><br><p>$txt{'326'}</p>
      </td>
      <td>
       <p><textarea name=ignore rows=10 cols=50 wrap=virtual>$imconfig[0]</textarea></p>
      </td>
     </tr>
     <tr>
      <td valign=top>
...
<tr>
	<td class="title1" bgcolor="$color{'titlebg'}"><p>$query</p></td>
</tr>
<tr>
