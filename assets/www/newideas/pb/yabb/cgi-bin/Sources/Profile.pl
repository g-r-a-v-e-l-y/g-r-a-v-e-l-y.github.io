...
<table border=0 width=100% cellspacing=1 bgcolor="$color{'bordercolor'}">
  <tr>
    <td class="title1" bgcolor="$color{'titlebg'}"><p>$txt{'79'} $txt{'517'}</p></td>
  </tr><tr>
    <td class="form1" bgcolor="$color{'windowbg'}"><p><form action="$cgi\&action=profile2" method="POST" name="creator">
    <table border=0>
      <tr>
	<td align="right"><p>$txt{'35'}: </p></td>
	<td><p><input type=hidden name="username" value="$INFO{'username'}">$INFO{'username'}</p></td>
      </tr><tr>
	<td align="right"><p>* $txt{'81'}: </p></td>
	<td><p><input type=password name=passwrd1 size=20 value="$memsettings[0]"></p></td>
      </tr><tr>
	<td align="right"><p>* $txt{'82'}: </p></td>
	<td><p><input type=password name=passwrd2 size=20 value="$memsettings[0]"></p></td>
      </tr><tr>
	<td align="right"><p>* $txt{'68'}: </p></td>
	<td><p><input type=text name=name size=30 value="$memsettings[1]"> $txt{'518'}</p></td>
      </tr><tr>
	<td align="right"><p>* $txt{'69'}: </p></td>
	<td><p><input type=text name=email size=30 value="$memsettings[2]"></p></td>
      </tr><tr>
	<td align="right"><p>$txt{'231'}: </p></td>
	<td>
	...
	<td align="right"><p>$txt{'420'}:</p></td>
	<td><p><input type=text name=age size=3 maxlength=2 value="$memsettings[16]"></p></td>
      </tr><tr>
	<td colspan=2>
	<BR><BR><p>________ $txt{'226'}: ________</p></td>
      </tr><tr>
	<td align="right"><p>$txt{'227'}: </p></td>
	<td><p><input type=text name=location size=50 value="$memsettings[15]"></p></td>
      </tr><tr>
	<td align="right"><p>$txt{'83'}: </p></td>
	<td><p><input type=text name=websitetitle size=50 value="$memsettings[3]"></p></td>
      </tr><tr>
	<td align="right"><p>$txt{'84'}: </p></td>
	<td><p><input type=text name=websiteurl size=50 value="$memsettings[4]"></p></td>
      </tr><tr>
	<td align="right"><p>$txt{'513'} #: </p></td>
	<td><p><input type=text name=icq size=20 value="$memsettings[8]"></p></td>
      </tr><tr>
	<td align="right"><p>AIM-Name: </p></td>
	<td><p><input type=text name=aim size=20 value="$memsettings[9]"></p></td>
      </tr><tr>
	<td align="right"><p>YIM-Name: </p></td>
	<td><p><input type=text name=yim size=20 value="$memsettings[10]"></p></td>
      </tr><tr>
	<td align="right"><p>$txt{'228'}: </p></td>
	<td><p><input type=text name=usertext size=50 value="$memsettings[12]"></p></td>
      </tr>
...
<td width="150"><p>$txt{'474'}<BR>$userpic_limits</p></td>
      </tr><tr>
EOT
...
print <<"EOT";
	...
	<td align="right"><p>$txt{'371'}:</p></td>
	<td><p><input name=usertimeoffset size=5 maxlength=5 value=$memsettings[18]> $txt{'519'}</td>
      </tr><tr>
	<td colspan=2><hr size=1 noshade></td>
      </tr><tr>
	<td align="right" valign=top><p>$txt{'85'}:</p></td>
	<td><p><textarea name=signature rows=4 cols=50 wrap=virtual>$signature</textarea></td>
      </tr>
EOT
	...
	if($settings[7] eq "Administrator") {
		...
		print <<"EOT";
      <tr>
	<td align="right"><p>$txt{'86'}: </p></td>
	<td><p><input type=text name=settings6 size=4 value="$memsettings[6]"></p></td>
      </tr><tr>
	<td align="right"><p>$txt{'87'}: </p></td>
	<td><p><select name="settings7">
...
<table border=0 width=300 cellpadding=2 cellspacing=2 bgcolor="$color{'bordercolor'}" align="center">
  <tr>
    ...
    <table border=0 cellspacing=0 cellpadding=0 width=100% bgcolor="$color{'bordercolor'}">
      <tr>
	<td class="title1"><p>$txt{'35'}: $INFO{'username'}</p></td>
	<td align="center" class="title1">
EOT
	if ($username eq $INFO{'username'} || $settings[7] eq "Administrator") {
		print <<"EOT";
	<p><a href="$cgi&action=profile&username=$INFO{'username'}"><p><< $txt{'17'} >></p></a></p>
EOT
	}
		print <<"EOT";
	</td>
	<td align="right" class="title1"><p>$txt{'232'}</p></td>
      </tr><tr height="100%">
	<td bgcolor="$color{'windowbg'}" colspan=2>
	<table border=0 width=400>
	  <tr>
	    <td align="right"><p>$txt{'68'}: </p></td>
	    <td><p>$memsettings[1]</p></td>
	  </tr><tr>
	    <td align="right"><p>$txt{'69'}: </p></td>
	    <td><p><a href="mailto:$memsettings[2]">$memsettings[2]</a></p></td>
	  </tr><tr>
	    <td align="right"><p>$txt{'231'}: </p></td>
	    <td><p>
EOT
...
print <<"EOT";
	    ...
	    <td align="right"><p>$txt{'420'}:</p></td>
	    <td><p>$memsettings[16]</p></td>
	  </tr><tr>
	    <td align="right"><p>$txt{'227'}: </p></td>
	    <td><p>$memsettings[15]</p></td>
	  </tr><tr>
	    <td align="right"><p>$txt{'96'}: </p></td>
	    <td><p><a href="$memsettings[4]" target=_blank>$memsettings[3]</a></p></td>
	  </tr><tr>
	    <td align="right"><p>ICQ: </p></td>
	    <td><p><a href="$cgi&action=icqpager&UIN=$icq" target=_blank>$memsettings[8]</a></p></td>
	  </tr><tr>
	    <td align="right"><p>AIM: </p></td>
	    <td><p>$memsettings[9]</p></td>
	  </tr><tr>
	    <td align="right"><p>YIM: </p></td>
	    <td><p>$memsettings[10]</p></td>
	  </tr><tr>
	    <td align="right"><p>$txt{'86'}: </p></td>
	    <td><p>$memsettings[6]</p></td>
	  </tr><tr>
	    <td align="right"><p>$txt{'87'}: </p></td>
	    <td><p>$memberinfo</p></td>
	  </tr><tr>
	    <td align="right"><p>$txt{'233'}: </p></td>
	    <td><p>$dr</p></td>
	  </tr><tr>
	    <td align="right"><p>$txt{'148'}: </p></td>
	    <td><p><a href="$cgi&action=imsend&to=$INFO{'username'}">[>>]</a></p></td>
	  </tr>
	</table>
	</td>
...
print <<"EOT";
	<p>$memsettings[12]</p></center></td>
      </tr><tr>
	<td colspan=3>
	<table border=0 cellspacing=1 cellpadding=0 width=100%>
	  <tr>
	    <td class="title1" bgcolor="$color{'titlebg'}"><p>$txt{'459'}:</p></td>
	  </tr><tr>
	    <td width="100%" height="100%" bgcolor="$color{'windowbg'}" valign="middle" align="center">
	    <p><form action="$cgi&action=usersrecentposts&username=$INFO{'username'}" method="POST">
		...
		foreach $curboard (@catinfo) {
			...
			#### output ####
				...
				for ($c = 0; $c < @text; $c++) {
					...
					$post=<<"EOT";
	<td width=75% bgcolor="$color{'titlebg'}"><p>&nbsp;$catinfo[0] / $boardinfo[0] / <a href="$boardurl/YaBB.pl?board=$board&action=display&num=$yytitle[0]"><p>$yytitle[1]</p></a></p></td>
	<td align=right bgcolor="$color{'titlebg'}"><nobr>&nbsp;<p>$txt{'30'}: $mdate&nbsp;</p></nobr></td>
</tr>
<tr height=80>
	<td colspan=3 bgcolor="$color{'windowbg2'}" valign=top><p>$message</p></td>
</tr>
<tr>
	<td colspan=3 bgcolor="$color{'catbg'}"><p>
...
print "\n<p>\n";
print "<p align=left><a href=\"$cgi&action=viewprofile&username=$INFO{'username'}\"><p>$txt{'92'} $memset[1]</p></a></p><p>\n";
...
<tr>
	<td align=left bgcolor="$color{'titlebg'}"><p>&nbsp;$j2&nbsp;</p></td>
EOT
		print "$data{$num[$j]}";
		$j++;
		}
