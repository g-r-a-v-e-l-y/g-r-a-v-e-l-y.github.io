...
<table width="100%" cellpadding=3 cellspacing=0 bgcolor="$color{'catbg'}">
  <tr height="30">
    <td align="left">
    <font size=2><b>$txt{'139'}:</b> $pageindex
</font></td>
...
<tr>
	...
	<td class="title1" bgcolor="$color{'titlebg'}" width=16><font size=2>&nbsp;</font></td>
	<td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'70'}</b></font></td>
	<td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'109'}</b></font></td>
	<td class="title1" bgcolor="$color{'titlebg'}" align=center><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'110'}</b></font></td>
	<td class="title1" bgcolor="$color{'titlebg'}" align=center><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'301'}</b></font></td>
	<td class="title1" bgcolor="$color{'titlebg'}" align=center><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'111'}</b></font></td>
EOT
...
<tr>
	...
	<td class="form1" valign=middle bgcolor="$color{'windowbg'}"><font size=2><a href="$cgi&action=display&num=$mnum"><b>$msub</b></a> $new $pages</font></td>
