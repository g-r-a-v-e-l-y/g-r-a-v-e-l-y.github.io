...
if ($dropdown eq "startuser") {
	...
	if ($newnumber > $totals) {
	$arrayend = $totals;
	$are_we_done = "<font class=\"text1\" size=2><b>$txt{'167'}</b> [ <a href=\"$boardurl/$thisprogram\">$txt{'168'}</a> ]<br></font>";
	}
	else {
...
<table width=100%>
<tr>
	<td><font class=\"text2\" size=2><IMG SRC="$imagesdir/open.gif" BORDER=0>&nbsp;&nbsp;<A href="$boardurl/YaBB.pl">$mbname</A><br><IMG SRC="$imagesdir/tline.gif" BORDER=0><IMG SRC="$imagesdir/open.gif" BORDER=0>&nbsp;&nbsp;<b>$txt{'166'}</b></font></td>
</tr>
</table>

<table border=0 width=100% cellspacing=1 cellpadding=4 bgcolor="$color{'bordercolor'}">
<tr>
<td colspan=\"2\" bgcolor=\"$color{'titlebg'}\"><font class=\"text2\" size=2 color=\"$color{'titletext'}\"><b>$txt{'173'}: $search - $totaldone $txt{'174'}</b></font></td>
</tr><tr>
...
EOT
		...
		print "<td bgcolor=\"$color{'windowbg2'}\" valign=top><font face=\"Verdana, Arial\" class=\"text2\" size=2>&nbsp;[ $tempcatboard] <a href=\"$boardurl/YaBB.pl?board=$temptitle&action=display&num=$tempmessage\" target=\"_blank\"><b>$tempmessagetitle</b></a></font></td>";
		print "</tr><tr>";
...
if ($dropdown eq "startpost") {
	...
	if ($newnumber >= $totals) {
	$arrayend = $totals;
	$are_we_done = "<font face=\"Verdana, Arial\" class=\"text1\" size=2><b>$txt{'167'}</b> [ <a href=\"$boardurl/$thisprogram\">$txt{'168'}</a> ]<br></font>";
	}
	else {
	$arrayend = ($numberreturned + $arraystart) - 1;
	$arraytostart = $arrayend + 1;
...
<table border=0 width=100% cellspacing=1 cellpadding=4 bgcolor="$color{'bordercolor'}">
<tr>
<td colspan=\"2\" bgcolor=\"$color{'titlebg'}\"><font face=\"Verdana, Arial\" class=\"text2\" size=2 color=\"$color{'titletext'}\"><b>$txt{'177'}: $search - $totaldone $txt{'174'}</b></font></td>
</tr><tr>
...
<table width=100%>
<tr>
	<td><font face="Verdana,Arial" size=2><IMG SRC="$imagesdir/open.gif" BORDER=0>&nbsp;&nbsp;<A href="$boardurl/YaBB.pl">$mbname</A><br><IMG SRC="$imagesdir/tline.gif" BORDER=0><IMG SRC="$imagesdir/open.gif" BORDER=0>&nbsp;&nbsp;<b>$txt{'166'}</b></font></td>
</tr>
</table>

<table border=0 width=100% cellspacing=1 cellpadding=4 bgcolor="$color{'bordercolor'}">
<tr>
<td colspan=\"2\" bgcolor=\"$color{'titlebg'}\"><font face=\"Verdana, Arial\" class=\"text2\" size=2 color=\"$color{'titletext'}\"><b>$txt{'180'} $search - $totaldone $txt{'174'}</b></font></td>
</tr><tr>
<td colspan=\"2\" bgcolor=\"$color{'windowbg'}\"><font face=\"Verdana, Arial\" class=\"text2\" size=2>$resulttext</font></td>
<tr>
EOT
