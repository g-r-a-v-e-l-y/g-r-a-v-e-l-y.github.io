...
<tr>
	...
	<td class="title1" bgcolor="$color{'titlebg'}"><font class="text1" color="$color{'titletext'}" size=1><b>$txt{'20'}</b></font></td>
	<td class="title1" bgcolor="$color{'titlebg'}" nowrap><font class="text1" color="$color{'titletext'}" size=1><b>$txt{'12'}</b></font></td>
	<td class="title1" bgcolor="$color{'titlebg'}" nowrap><font class="text1" color="$color{'titletext'}" size=1><b>$txt{'42'}</b></font></td>
</tr>
EOT
	foreach $curcat (@categories) {
		...
		print <<"EOT";
<tr>
	<td colspan=4 bgcolor="#c0c0c0"><font size=2><a href="$cgi&action=reorderboards&cat=$curcat"><b>$curcatname</b></a></font></td>
</tr>
EOT
...
<table border=0 width=100% cellspacing=1 bgcolor="$color{'bordercolor'}">
<tr>
	<td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'46'}</b></font></td>
</tr>
<tr>
