...
<tr>
 <td class="title1" bgcolor="$color{'titlebg'}" width="300"><font size=2 class="text1" color="$color{'titletext'}">&nbsp;<b>$txt{'317'}</b></font></td>
 <td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'318'}</b></font></td>
 <td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'319'}</b></font></td>
...
<table border=0 width=100% cellspacing=1 bgcolor="$color{'bordercolor'}">
<tr>
 <td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}">&nbsp;<b>$txt{'29'}</b></font></td>
 <td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'118'}</b></font></td>
</tr>
EOT
...
<tr>
	...
	<font size=2><b><a href=\"$cgi\&action=viewprofile\&username=$musername[$a]\">$memset[1]</a></b></font><br>
...
<tr>
	<td width=100%><a name="$messageid[$a]"><font size=1>&nbsp;<b>$subject</b></font></td>
	<td align=right nowrap><font size=1><b>$txt{'30'}:</b> $mydate</font></td>
</tr>
</table>
	<hr></font>
<font size=2>
...
<font size=1><a href="$cgi&action=imsend&caller=1&num=$a&quote=1&to=$musername[$a]">$txt{'145'}</a> | <a href="$cgi&action=imsend&caller=1&num=$a&reply=1&to=$musername[$a]">$txt{'146'}</a> | <a href="$cgi&action=imremove&caller=1&caller=1&id=$messageid[$a]"><b>$txt{'154'}</b></a></font></td></tr></table></td>
</tr>
EOT
;
	}
...
<tr>
 <td class="title1" bgcolor="$color{'titlebg'}" width="300"><font size=2 class="text1" color="$color{'titletext'}">&nbsp;<b>$txt{'317'}</b></font></td>
 <td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'324'}</b></font></td>
 <td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'319'}</b></font></td>
 <td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}">&nbsp;</font></td>
</tr>
EOT
...
<tr>
	...
	<table border=0 cellspacing=0 cellpadding=0 width=100%>
<tr>
	<td width=100%><font size=1><a name="$messageid[$a]">&nbsp;<b>$subject</b></font></td>
	<td align=right nowrap><font size=1><b>$txt{'30'}:</b> $mydate</font></td>
</tr>
</table>
	<hr></font>
...
<font size=1><a href="$cgi&action=imsend&caller=2&num=$a&quote=1&to=$musername[$a]">$txt{'145'}</a> | <a href="$cgi&action=imsend&caller=2&num=$a&reply=1&to=$musername[$a]">$txt{'146'}</a> | <a href="$cgi&action=imremove&caller=2&id=$messageid[$a]"><b>$txt{'154'}</b></a></font></td></tr></table></td>
</tr>
EOT
;
	}
...
<table border=0 width=100% cellspacing=1 bgcolor="$color{'bordercolor'}">
 <tr>
  <td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'148'}</b></font></td>
 </tr>
 <tr>
...
<table border=0 width=100% cellspacing=1 bgcolor="$color{'bordercolor'}">
 <tr>
  <td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'323'}</b></font></td>
 </tr>
 <tr>
  <td class="form1" bgcolor="$color{'windowbg'}">
...
<tr>
	<td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}"><b>$query</b></font></td>
</tr>
<tr>
