...
<tr>
	<td class="title1" bgcolor="$color{'titlebg'}" colspan="7"><b><font size=2 class="text1" color="$color{'titletext'}">$Sort</font></b></td>
</tr>
);
if($LetterLinks ne "") {
	$TableHeader .= qq(<tr>
		<td class="cat1" bgcolor="$color{'catbg'}" colspan="7"><b><font size=2>$LetterLinks</td>
	</tr>
	);
}
$TableHeader .= qq(<tr>
	<td class="cat1" bgcolor="$color{'catbg'}" width=100><b><font size=2>$txt{'35'}</font></b></td>
	<td class="cat1" bgcolor="$color{'catbg'}"><b><font size=2>$txt{'307'}</font></b></td>
	<td class="cat1" bgcolor="$color{'catbg'}"><b><font size=2>$txt{'96'}</font></b></td>
	<td class="cat1" bgcolor="$color{'catbg'}"><b><font size=2>$txt{'86'}</font></b></td>
	<td class="cat1" bgcolor="$color{'catbg'}"><b><font size=2>$txt{'87'}</font></b></td>
	<td class="cat1" bgcolor="$color{'catbg'}"><b><font size=2>ICQ</font></b></td>
	<td class="cat1" bgcolor="$color{'catbg'}"><b><font size=2>$txt{'21'}</font></b></td>
</tr>
);
...
sub MLAll {
	...
	print qq(
		...
		<tr>
			...
			<font size=2 color="#FFFFFF"><B>$txt{'308'} $numbegin $txt{'311'} $numend ($txt{'309'} $memcount $txt{'310'})</B></font>
			</td>
		</tr>
		</table>
	);
