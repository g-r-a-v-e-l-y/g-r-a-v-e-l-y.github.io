...
<table border=0 width=100% cellspacing=1 bgcolor="$color{'bordercolor'}">
  <tr>
    <td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'79'}</b> $txt{'517'}</font></td>
  </tr><tr>
	...
	<td align="right"><font size=2>* <b>$txt{'81'}: </b></font></td>
	<td><font size=2><input type=password name=passwrd1 size=20 value="$memsettings[0]"></font></td>
      </tr><tr>
	<td align="right"><font size=2>* <b>$txt{'82'}: </b></font></td>
	...
	<td align="right"><font size=2><b>$txt{'231'}: </b></font></td>
	<td>
...
print <<"EOT";
      <tr>
	<td align="right"><b><font size=2>$txt{'229'}:</B></font></td>
      <td>
...
print <<"EOT";
	<td align="right"><font size="2"><B>$txt{'475'}</B></font></td>
	<td><input type="checkbox" name="userpicpersonalcheck" $checked>
	<input type="text" name="userpicpersonal" size="45" value="$tmp"></td>
      </tr><tr>
	<td colspan=2><hr size=1 noshade></td>
      </tr><tr>
	<td colspan=2><font size=2><b>$txt{'479'}:</b></font></td>
      </tr><tr>
	<td align="right"><font size=2><b>$txt{'486'}:</b></font></td>
	<td width="50">
EOT
...
print <<"EOT";
	...
	<td align="right"><font size=2><b>$txt{'371'}:</b></font></td>
	<td><font size=2><input name=usertimeoffset size=5 maxlength=5 value=$memsettings[18]> $txt{'519'}</td>
      </tr><tr>
	<td colspan=2><hr size=1 noshade></td>
      </tr><tr>
	<td align="right" valign=top><font size=2><b>$txt{'85'}:</b></font></td>
...
EOT
	...
	if($settings[7] eq "Administrator") {
		...
		print <<"EOT";
      <tr>
	<td align="right"><font size=2><b>$txt{'86'}: </b></font></td>
	<td><font size=2><input type=text name=settings6 size=4 value="$memsettings[6]"></font></td>
      </tr><tr>
	<td align="right"><font size=2><b>$txt{'87'}: </b></font></td>
...
<table border=0 width=300 cellpadding=2 cellspacing=2 bgcolor="$color{'bordercolor'}" align="center">
  <tr>
    ...
    <table border=0 cellspacing=0 cellpadding=0 width=100% bgcolor="$color{'bordercolor'}">
      <tr>
	<td class="title1"><font size=2 class="text1" color="$color{'titletext'}"><B>$txt{'35'}: $INFO{'username'}</b></font></td>
...
print <<"EOT";
	    ...
	    <td align="right"><font size=2><b>$txt{'96'}: </b></font></td>
	    ...
	    <td align="right"><font size=2><b>$txt{'233'}: </b></font></td>
	    <td><font size=2>$dr</font></td>
	  </tr><tr>
	    <td align="right"><font size=2><b>$txt{'148'}: </b></font></td>
...
print <<"EOT";
	...
	<table border=0 cellspacing=1 cellpadding=0 width=100%>
	  <tr>
	    <td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'459'}:</b></font></td>
	  </tr><tr>
		...
		foreach $curboard (@catinfo) {
			...
			#### output ####
				...
				for ($c = 0; $c < @text; $c++) {
					...
					$post=<<"EOT";
	<td width=75% bgcolor="$color{'titlebg'}"><font class="text1" color="$color{'titletext'}" size=2><b>&nbsp;$catinfo[0] / $boardinfo[0] / <a href="$boardurl/YaBB.pl?board=$board&action=display&num=$yytitle[0]"><font class="text1" color="$color{'titletext'}" size=2>$yytitle[1]</font></a></b></font></td>
...
print "<p align=left><a href=\"$cgi&action=viewprofile&username=$INFO{'username'}\"><font size=2><b>$txt{'92'} $memset[1]</b></font></a></p><p>\n";
