...
<table border="0" cellpadding="3" cellspacing="0" width="750" height="158" align="center">
  ...
  <tr>
    <td width="400" bgcolor="$color{'windowbg'}" height="21"><font size="3"><b class="blacky">$txt{'426'}</td>
  </tr>
  <tr>
    <td width="400" bgcolor="$color{'windowbg2'}" height="21"><font size="2"><a class="blacky" href="$cgi&action=viewmembers">$txt{'5'}</a><br>
  ...
  <tr>
    <td width="400" bgcolor="$color{'windowbg'}" height="21"><font size="3"><b class="blacky">$txt{'427'}</td>
  </tr>
  <tr>
    <td width="400" bgcolor="$color{'windowbg2'}" height="21"><font size="2"><a class="blacky" href="$cgi&action=managecats">$txt{'3'}</a><br>
  ...
  <tr>
    <td width="400" bgcolor="$color{'windowbg'}" height="1"><font size="3"><b class="blacky">$txt{'428'}</td>
  </tr>
  <tr>
    <td width="400" bgcolor="$color{'windowbg2'}" height="21"><font size="2"><a class="blacky" href="$cgi&action=editnews">$txt{'7'}</a><br>
  ...
  <tr>
    <td width="400" bgcolor="$color{'windowbg'}" height="1"><font size="3"><b class="blacky">$txt{'501'}</td>
  </tr>
  <tr>
    <td width="400" bgcolor="$color{'windowbg2'}" height="21"><font size="2"><a class="blacky" href="$cgi&action=boardrecount">$txt{'502'}</a><br>
    </td>
  </tr>
  <tr>
    <td width="400" bgcolor="$color{'windowbg2'}" height="21"><font size="2"><a class="blacky" href="$cgi&action=membershiprecount">$txt{'504'}</a><br>
    </td>
  </tr>
  <tr>
