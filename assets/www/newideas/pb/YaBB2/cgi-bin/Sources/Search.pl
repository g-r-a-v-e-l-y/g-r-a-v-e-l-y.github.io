...
<table width=100%>
<tr>
	<td><font face="Verdana,Arial" size=2><IMG SRC="$imagesdir/open.gif" BORDER=0>&nbsp;&nbsp;<A href="$boardurl/YaBB.pl">$mbname</A><br><IMG SRC="$imagesdir/tline.gif" BORDER=0><IMG SRC="$imagesdir/open.gif" BORDER=0>&nbsp;&nbsp;$txt{'182'}</font></td>
</tr>
</table>
