...
#	to place CGI scripts in a cgi directory, you have done so.
#
...
#	a cgi directory, it is generally best to make all three paths the
#	same. If, however, it is a cgi directory, you may have server
#	problems if you keep your news files in it. Create another directory,
#	outside your cgi, and CHMOD it 777. Set the News File and Archive
...
http://www.mysite.com/mypage/cgi/newspro/news.txt, and the file you're
including it in is in any other directory on your site, use:

<!--#include virtual="/mypage/cgi/newspro/news.txt" -->
