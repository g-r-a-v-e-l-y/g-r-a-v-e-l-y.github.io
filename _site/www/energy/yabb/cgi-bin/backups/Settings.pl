...
$mbname = "plan:b messageboard";                  # The name of your
$boardurl = "http://129.100.108.56/pb/yabb/cgi-bin"; # URL of your board (without trailing '/')
$cookieusername = "yusername";             # Name of the username cookie
$cookiepassword = "ypassword";             # Name of the password cookie
$maxdisplay = 15;                          # Maximum of threads to display
...
$helpfile = "http://129.100.108.56/pb/help.html"; # Location of your help file

######## Directories ############
$boarddir = '/usr/local/www/data/pb/yabb/cgi-bin'; # . = Current directory, can be replace by absolute path (/home/user/YaBB)
...
######## Colors #################
$color{'titlebg'}    = "\#00B2EB";    # Background color of the 'title-bar'
