...
<link REL="SHORTCUT ICON" href="$NonCGIURL/ubbfavicon.ico">
 ...
 <BODY bgcolor="$BGColor" text="$TextColor" link="$LinkColor" alink="$ActiveLinkColor" vlink="$VisitedLinkColor" topmargin=0>
...
<BR>
<FONT SIZE="2" FACE="$FontFace" color="$LinkColor"><B>$Forum</B>
<br><FONT size= "1" COLOR="$CopyrightTextColor">(moderated by <A HREF="mailto:$ModeratorEmail">$Moderator</A>)
<P>
</FONT></font>
</td>
...
<CENTER>
<FONT SIZE="2" FACE="$FontFace">
<A HREF="$CGIURL/postings.cgi?action=newtopic&number=$number&forum=$ForumCoded&DaysPrune=$DaysPrune"><IMG SRC="$NonCGIURL/$BBTopic"  BORDER=0 ALT="Post New Topic"></A></FONT>
<BR>
...
print <<GUTS;
<TR>
<TD bgcolor="$AltColumnColor1"><IMG SRC="$NonCGIURL/closed.gif" WIDTH=14 HEIGHT=11 BORDER=0><FONT SIZE="2" FACE="$FontFace">&nbsp;
<A HREF="$NonCGIURL/Forum$number/HTML/$threadinfo[3]">$threadinfo[4]</A>
</FONT>
</td>
<td bgcolor="$AltColumnColor2">
<FONT SIZE="2" FACE="$FontFace">$threadinfo[6]</FONT>
</td>
<td align=center bgcolor="$AltColumnColor1">
<FONT SIZE="2" FACE="$FontFace">$threadinfo[5]</FONT>
</td>
<td NOWRAP bgcolor="$AltColumnColor2">
<FONT SIZE="2" FACE="$FontFace">$TheDate <FONT SIZE="1" FACE="$FontFace" COLOR="$LinkColor">$FormatTime</FONT></FONT>
</td></tr>
GUTS
...
<FONT SIZE="1" FACE="$FontFace" COLOR="$CopyrightTextColor">All times are $TimeZone. $DateWording</FONT></td>
