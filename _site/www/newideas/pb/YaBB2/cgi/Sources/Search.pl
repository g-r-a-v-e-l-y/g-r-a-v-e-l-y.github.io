...
<table width=100%>
<tr>
	<td><font face="Verdana,Arial" size=2><IMG SRC="$imagesdir/open.gif" BORDER=0>&nbsp;&nbsp;<A href="$boardurl/YaBB.pl">$mbname</A><br><IMG SRC="$imagesdir/tline.gif" BORDER=0><IMG SRC="$imagesdir/open.gif" BORDER=0>&nbsp;&nbsp;<b>$txt{'182'}</b></font></td>
</tr>
</table>

<table border=0 width=100% cellspacing=1 cellpadding=4 bgcolor="$color{'bordercolor'}">
<tr>
  <td class="title1" bgcolor="$color{'titlebg'}"><font size=2 class="text1" color="$color{'titletext'}">$txt{'183'}</font></td>
