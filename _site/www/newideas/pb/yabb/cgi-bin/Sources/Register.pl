...
<tr>
	<td class="title1" bgcolor="$color{'titlebg'}"><p>$txt{'97'} $txt{'517'}</p></td>
</tr>
<tr>
	<td class="form1" bgcolor="$color{'windowbg'}"><p><form action="$cgi\&action=register2" method="POST" name="creator">
<table border=0>
<tr>
	<td align="right"><p>* $txt{'98'}: </p></td>
	<td><p><input type=text name=username size=20> $txt{'520'}</p></td>
</tr>
<tr>
	<td align="right"><p>* $txt{'81'}: </p></td>
	<td><p><input type=password name=passwrd1 size=20></p></td>
</tr>
<tr>
	<td align="right"><p>* $txt{'82'}: </p></td>
	<td><p><input type=password name=passwrd2 size=20></p></td>
</tr>
<tr>
	<td align="right"><p>* $txt{'68'}: </p></td>
	<td><p><input type=text name=name size=30> $txt{'518'}</p></td>
</tr>
<tr>
...
<tr>
	...
	<td><p><input type=text name=age size=3 maxlength=2></p></td>
</tr>
<tr>
	<td colspan=2>
...
<tr>
	...
	<td><p><input type=text name=location size=50></p></td>
</tr>
<tr>
	<td align="right"><p>$txt{'83'}: </p></td>
	<td><p><input type=text name=websitetitle size=50></p></td>
</tr>
<tr>
	<td align="right"><p>$txt{'84'}: </p></td>
	<td><p><input type=text name=websiteurl size=50 value="http://"></p></td>
</tr>
<tr>
	<td align="right"><p>$txt{'513'} #: </p></td>
	<td><p><input type=text name=icq size=20></p></td>
</tr>
<tr>
	<td align="right"><p>AIM-Name: </p></td>
	<td><p><input type=text name=aim size=20></p></td>
</tr>
<tr>
	<td align="right"><p>YIM-Name: </p></td>
	<td><p><input type=text name=yim size=20></p></td>
</tr>
<tr>
	<td align="right"><p>$txt{'228'}: </p></td>
	<td><p><input type=text name=usertext size=50 value="$txt{'209'}"></p></td>
</tr>
EOT
...
<tr>
	...
	<td><p><input name=usertimeoffset size=5 maxlength=5> $txt{'519'}</p></td>
</tr>
<tr>
      <td colspan=2><hr size=1 noshade></td>
</tr>
...
<tr>
	...
	<td><p><textarea name=signature rows=4 cols=50 wrap=virtual></textarea></td>
</tr>
<tr>
...
<tr>
	<td class="title1" bgcolor="$color{'titlebg'}"><p>$txt{'97'}</p></td>
</tr>
<tr>
	<td class="form1" bgcolor="$color{'windowbg'}" align="center"><p><form action="$cgi\&action=login2" method="POST">
