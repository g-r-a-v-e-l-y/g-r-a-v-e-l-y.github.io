...
module.exports = {
  ...
  site: {
    ...
    title: 'gimme pizza slow (high quality)',
    ...
    url: process.env.URL || 'https://www.gravely.pizza/',
    ...
    fediverse: [
      {
        ...
        url: 'https://mastodon.social/@gravely',
      },
    ],
  },
  // ---------------------------------------------------------------------------
