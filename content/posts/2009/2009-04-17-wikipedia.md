...
![Wikipedia front page](wikipedia.off.png)

![Wikipedia main page](en.wikipedia.off.png)
...
![Wikipedia front page](wikipedia.png)

![Wikipedia main page](en.wikipedia.png)
...
![Wikipedia as an editor](prefs.png)

Try it in Helvetica. ![Wikipedia in Helvetica](helvetica.png)

Or Wikipedia's logotype, Hoefler Text. ![Wikipedia in Hoefler Text](hoefler.png)
